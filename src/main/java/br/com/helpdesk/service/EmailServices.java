...
public class EmailServices {
  ...
  // public void enviarEmailTemplate(String destinatario, String titulo,
  ...
  // try {
  // content.append(FreeMarkerTemplateUtils.processTemplateIntoString(fmConfiguration.getTemplate("email-recuperacao-codigo.flth"),
  // model));
  // } catch (Exception e) {
  // e.printStackTrace();
  // }
